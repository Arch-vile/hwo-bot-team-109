...
public class SimplePaddleMover implements Runnable {

	private static Logger logger = Logger.getLogger(SimplePaddleMover.class);
	...
	//xxxprivate float evaluatedMaxSpeed = 0;
	
	
	public SimplePaddleMover(ServerClone serverClone, Messenger messenger) {
